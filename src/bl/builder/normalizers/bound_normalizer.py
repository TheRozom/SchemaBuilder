...
class BoundNormalizer:
    def smart_maximum(
        self, value: Optional[Union[int, float]], padding: float = 0.0
    ...
    def _ceil_to_clean(self, value: Union[int, float], is_int: bool = False) -> Union[int, float]:
        abs_val = abs(value)
    ...
    def _floor_to_clean(self, value: Union[int, float], is_int: bool = False) -> Union[int, float]:
        abs_val = abs(value)
        step = self._compute_step(abs_val)
